...
try:
    ...
    data = parse_franchise(xlsx_path, "Papa Johns España", "Mayo 2026", "01 – 31 Mayo 2026")
    ...
    with open("debug_pj_spain.json", "w", encoding="utf-8") as f:
        json.dump(data, f, ensure_ascii=False, indent=2)
    print("Saved debug_pj_spain.json successfully!")
