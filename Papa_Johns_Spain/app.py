...
FRANCHISES = ['Papa Johns España']

AVAILABLE_MONTHS = {
    'Papa Johns España': ['Marzo 2026', 'Abril 2026', 'Mayo 2026'],
}
...
def export_pdf():
    ...
    try:
        ...
        response.headers['Content-Disposition'] = f'attachment; filename=PJ_Spain_{period.replace(" ", "_")}_REPORT.pdf'
        return response
    except Exception as e:
...
def export_pptx():
    ...
    try:
        ...
        response.headers['Content-Disposition'] = f'attachment; filename=PJ_Spain_{period.replace(" ", "_")}_REPORT.pptx'
        return response
