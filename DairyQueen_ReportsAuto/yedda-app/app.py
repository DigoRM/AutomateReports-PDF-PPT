...
def export_pdf():
    ...
    try:
        ...
        response.headers['Content-Disposition'] = f'attachment; filename=DQ_{franchise}_{period.replace(" ", "_")}_REPORT.pdf'
        return response
    except Exception as e:
...
def export_pptx():
    ...
    try:
        ...
        response.headers['Content-Disposition'] = f'attachment; filename=DQ_{franchise}_{period.replace(" ", "_")}_REPORT.pptx'
        return response
