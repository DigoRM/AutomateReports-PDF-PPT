...
# 1. Title
content = re.sub(r'<title>DQ Zamabrands · Abril 2026 · DA07QUMX</title>',
                 r'<title>DQ {{ franchise }} · {{ period }} · DA07QUMX</title>', content)
...
# 3. Delivery Insight
del_ins_old = r'<div class="ins"><span style="font-size:18px">📊</span><span><strong>Insight:</strong> Mejor: DQ TOWN SQUARE \(0:41\) &nbsp;·&nbsp; Peor: DQ SAN ANGEL \(5:07\) &nbsp;·&nbsp; 21.35% supera los 3 minutos de espera</span></div>'
...
dt_ins_old = r'<div class="ins"><span>🚗</span><span>Zamabrands registró <strong>0 alertas Drive Thru</strong> en \{\{ period \}\}. Las estaciones de Drive Thru operaron sin incidencias detectadas en este período.</span></div>'
