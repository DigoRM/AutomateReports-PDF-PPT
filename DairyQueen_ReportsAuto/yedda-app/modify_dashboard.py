...
# Replace top-meta
content = re.sub(
    r'<div class="top-meta">Dairy Queen México · Zamabrands · 62 Tiendas · Abril 2026</div>',
    r'<div class="top-meta">Dairy Queen México · {{ franchise }} · {{ n_stores }} Tiendas · {{ period }}</div>',
    content
)
