# Guía Técnica de Arquitectura y Diseño Visual de Reportes (IceCream Co. Template)
...
3. **Ejecutar Pruebas Locales de Compilación:**
   ...
   * `node optimareports-app/test_js.js` (Debe reportar success en todos los módulos de dibujo).
   * `python optimareports-app/test_all_parsers.py` (Debe verificar la correcta conversión de las planilhas Excel a JSON).
