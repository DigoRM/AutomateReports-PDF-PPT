...
ROW = {
    ...
    'receiving': 51,   # Total Experience Time (mapped to receiving in IC dashboard)
    ...
    # Receiving Time ranges (mapped to Total Experience Time ranges in PG)
    ...
    'del_time': 62,         # Average duration before delivery of PizzaGroup's riders
    'del_lt2': 63,          # 1 - 3 minutes
    'del_2to3': 64,         # 4 - 7 minutes
    'del_gt3': 66,          # More than 10 minutes
    'delivery_total': 52,   # Mapped to service_total since delivery is under Service in PG
...
KBP1_CE = [
    ...
    ('Entregador PG permanece en tienda >5 minutos',       'driver_5min'),
]
